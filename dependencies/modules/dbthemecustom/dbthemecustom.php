...
class Dbthemecustom extends Module
{
    ...
    public function addValues()
    {
        ...
        Configuration::updateValue('DBTHEMECUSTOM_PRIMARY_COLOR', '#2fe8bc');
        Configuration::updateValue('DBTHEMECUSTOM_SECOND_COLOR', '#e98b2e');
        Configuration::updateValue('DBTHEMECUSTOM_BK', '#FAF9F9');
        Configuration::updateValue('DBTHEMECUSTOM_COLOR_FONT', '#1F1F1F');
        Configuration::updateValue('DBTHEMECUSTOM_COLOR_LINK', '#2fe8bc');
        ...
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_P_BK', '#2fe8bc');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_P_COLOR', '#ffffff');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_P_BORDER', '#2fe8bc');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_P_BK_HOVER', '#000000');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_P_COLOR_HOVER', '#ffffff');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_P_BORDER_HOVER', '#000000');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_S_BK', '#ffffff');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_S_COLOR', '#000000');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_S_BORDER', '#000000');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_S_BK_HOVER', '#ffffff');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_S_COLOR_HOVER', '#2fe8bc');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_S_BORDER_HOVER', '#2fe8bc');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_T_BK', '#ffffff');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_T_COLOR', '#000000');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_T_BORDER', '#000000');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_T_BK_HOVER', '#ffffff');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_T_COLOR_HOVER', '#2fe8bc');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_T_BORDER_HOVER', '#2fe8bc');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_BK', '#2fe8bc');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_COLOR', '#ffffff');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_BORDER', '#2fe8bc');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_BK_HOVER', '#000000');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_COLOR_HOVER', '#ffffff');
        Configuration::updateValue('DBTHEMECUSTOM_BUTTON_BORDER_HOVER', '#000000');

        Configuration::updateValue('DBTHEMECUSTOM_HEADER_WIDTH', 0);
        Configuration::updateValue('DBTHEMECUSTOM_DISPLAYNAV', 1);
        Configuration::updateValue('DBTHEMECUSTOM_TOPBAR_BK', '#FFFFFF');
        Configuration::updateValue('DBTHEMECUSTOM_TOPBAR_COLOR_FONT', '#000000');
        Configuration::updateValue('DBTHEMECUSTOM_TOPBAR_COLOR_LINK', '#2fe8bc');
        Configuration::updateValue('DBTHEMECUSTOM_TOPBAR_COLOR_HOVER', '#2fe8bc');
        Configuration::updateValue('DBTHEMECUSTOM_HEADER_BK', '#ffffff');
        Configuration::updateValue('DBTHEMECUSTOM_HEADER_COLOR_FONT', '#000000');
        Configuration::updateValue('DBTHEMECUSTOM_HEADER_COLOR_LINK', '#2fe8bc');
        Configuration::updateValue('DBTHEMECUSTOM_HEADER_COLOR_HOVER', '#2fe8bc');
        Configuration::updateValue('DBTHEMECUSTOM_SEARCH_BK', '#FFFFFF');
        Configuration::updateValue('DBTHEMECUSTOM_SEARCH_COLOR_FONT', '#000000');
        Configuration::updateValue('DBTHEMECUSTOM_COLOR_ICONS_HEADER', '#2fe8bc');

        Configuration::updateValue('DBTHEMECUSTOM_FOOTER_WIDTH', 0);
        Configuration::updateValue('DBTHEMECUSTOM_PREFOOTER_BK', '#000000');
        Configuration::updateValue('DBTHEMECUSTOM_PREFOOTER_COLOR_FONT', '#FFFFFF');
        Configuration::updateValue('DBTHEMECUSTOM_PREFOOTER_COLOR_LINK', '#FFFFFF');
        Configuration::updateValue('DBTHEMECUSTOM_PREFOOTER_COLOR_HOVER', '#FFFFFF');
        Configuration::updateValue('DBTHEMECUSTOM_FOOTER_BK', '#000000');
        ...
        Configuration::updateValue('DBTHEMECUSTOM_FOOTER_COLOR_HOVER', '#FFFFFF');
        Configuration::updateValue('DBTHEMECUSTOM_FOOTER_BK', '#000000');
        Configuration::updateValue('DBTHEMECUSTOM_FOOTER_COLOR_FONT', '#FFFFFF');
